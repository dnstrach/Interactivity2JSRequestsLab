...
/*
    ...
    its text color to white (you can use the .style object or create a CSS class and use classList.add)
...
/*
    ...
    Inside the repeatMyParam function above, 
    grab the element with the id of 'repeat-text' 
...
/*
    ...
    Inside the function, select the input you just created 
    in the HTML and save it to a variable called foodInput. 
    
    Next, create an object called body inside the function. 
    It should have one key-value pair. The key should be newFood 
    (make sure to match the case and spelling exactly) 
    and the value should be the value of the food input. 

    Now make an axios post request to /food. Inside the parentheses 
    where you passed the URL in, pass in body as the second argument. 
